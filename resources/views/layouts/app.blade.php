            ...
            <div class="relative flex items-center justify-between h-16">
                ...
                <div class="flex items-center justify-center flex-1 sm:items-stretch sm:justify-start">
                    <div class="flex items-center flex-shrink-0">
                        <img class="block w-auto h-10 lg:hidden" src="{{ asset('images/awn-small.png') }}"
                            alt="AWN Logo">
                        <img class="hidden w-auto h-10 lg:block" src="{{ asset('images/awn-small.png') }}"
                            alt="AWN Logo">
                    </div>
            ...
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                ...
                <img class="w-8 h-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                    ...
                    <div class="relative ml-3">
                        <a href="#" class="block px-3 py-2 text-base font-medium text-white rounded-md"
